...
# Look and feel
		general = {
			...
			"gaps_out" = "5";
			"border_size" = "2";
			"col.active_border" = "${gradientColors.first} ${gradientColors.second} ${gradientColors.third} ${gradientColors.fourth} ${gradientColors.fifth} ${gradientColors.sixth} 45deg";
